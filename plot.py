...
[image_names, numberOfFiles] = filterFiles("./JPEGImages", "jpg")    

trainRCNN = pd.read_csv('blood_cell_training.csv', sep=",", header=None)
...
for imageFileName in image_names:    
    ...
    image = plt.imread('./JPEGImages/' + imageFileName)
    plt.imshow(image)
